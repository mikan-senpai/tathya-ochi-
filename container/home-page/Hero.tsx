...
import { awwwards, tathyaTech2 } from "@/public";
								...
								<div className="flex items-center gap-[5px]">
									<motion.span
										...
										<Image
											...
											src={tathyaTech2}
											alt="img"
											className="w-auto h-[155px] lg:w-auto lg:h-[150px] md:w-[120px] md:h-[80px] sm:w-[90px] sm:h-[60px] xm:w-[80px] xm:h-[50px] xl:mt-[15px] mt-[10px] rounded-[10px]"
										/>
									</motion.span>
						...
						<div className="flex justify-between items-center padding-x gap-[20px] sm:flex-col sm:items-start xm:flex-col xm:items-start">
							<div className="w-[50%] xm:w-full sm:w-full">
								<p className="paragraph font-NeueMontreal text-secondry">
									For enterprises and growing businesses
								</p>
							</div>
